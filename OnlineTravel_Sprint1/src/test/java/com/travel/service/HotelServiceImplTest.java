...
class HotelServiceImplTest {
	...
	void testInsertHotel() throws Exception {
		// given
		Hotel sampleInput = new Hotel("Polish-heaven", "Araku", 3);
		Hotel expectedOutput = new Hotel("Polish-heaven", "Araku", 3);
	...
	void testGetAllHotels() throws Exception {
		...
		Hotel hotel1 = new Hotel("Polish-heaven", "Araku", 3);
		hotel1.setHotelReviews(null);
		Hotel hotel2 = new Hotel("ParkLand", "Ooty", 4);
